...
const News = (props) => {
  ...
  const fetchMoreData = async () => {
    setpage(page + 1)
    setloading(true)
    let url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=334a8ff6e1fa4d56a07e55e481202d76&page=${page}&pagesize=${props.pageSize}`;
